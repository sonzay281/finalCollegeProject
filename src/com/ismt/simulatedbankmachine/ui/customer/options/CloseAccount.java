...
public class CloseAccount extends JFrame {
	 ...
	 * Create the frame.
	 */
	public CloseAccount(int accountNo) {
		...
		comboBox.setModel(new DefaultComboBoxModel<String>(new String[] { "TEMPORARY" }));
				...
				try {
					...
					if (updated != 0) {
						JOptionPane.showMessageDialog(null,
								"Account no:" + accountNo + "has been closed successfully.");
						System.exit(0);
					} else {
						JOptionPane.showMessageDialog(null,
